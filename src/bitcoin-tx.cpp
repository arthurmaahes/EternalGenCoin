...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s eternal-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  eternal-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded eternal transaction") + "\n" +
              "  eternal-tx [options] -create [commands]   " + _("Create hex-encoded eternal transaction") + "\n" +
              "\n";
