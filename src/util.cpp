...
const char * const BITCOIN_CONF_FILENAME = "eternal.conf";
const char * const BITCOIN_PID_FILENAME = "eternal.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "EternalGen";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/EternalGen";
#else
    // Unix
    return pathRet / ".eternal";
#endif
#endif
}
