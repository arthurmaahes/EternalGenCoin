...
#if defined(NDEBUG)
# error "EternalGen cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "EternalGen Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s ETG additional fees, %d delta bytes\n",
